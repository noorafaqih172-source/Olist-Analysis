...
### Scenario
Olist is a Brazilian e-commerce platform currently using experience-based pricing, which leads to inconsistencies across products and regions.This project aims to build a data-driven pricing model that optimizes product prices across states and categories.

### Approaches
1- Are vouchers distributed equally across states and categories?

2- Are vouchers being misused by customers?

3- Are vouchers distributed evenly throughout the year?

4- Do installments generate more income?
...
2- Voucher use is minimal.

3- Customers are highly price-sensitive.

4- Purchasing behavior varies across categories and regions.

### Recommendations
1- Promote Installments for High-Value Products.

2- Expand Voucher Programs.

3- Adjust Prices by Category.

4- Use Small Discounts (5–10%) for Mid-Range Items.

5- Reduce Freight Barriers.
